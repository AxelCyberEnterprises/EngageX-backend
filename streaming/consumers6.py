...
# Decorate with database_sync_to_async to run this synchronous DB method in a thread
    ...
    def get_session_chunk_urls(self, session_id):
        ...
        try:
            # Order by creation time to ensure correct concatenation order
            chunks = SessionChunk.objects.filter(session__id=session_id).order_by('created_at')
...
# Other parts of the LiveSessionConsumer class remain the same